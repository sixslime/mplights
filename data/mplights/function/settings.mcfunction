...
#>-------------------
#> torch.burnout_percent
#: {normal: float, soul: float}
#-------------------
...
#>-------------------
#> torch.brightness
#: {normal: {min: int, max :int}, soul: {min: int, max: int}
#-------------------
...
#>-------------------
#> torch.burn_time_per_additional
#: {normal: int, soul: int}
#-------------------
...
#>-------------------
#> torch.extinguish_in_water
#: {normal: bool, soul: bool}
#-------------------
